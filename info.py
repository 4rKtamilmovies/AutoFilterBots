...
API_ID = int(environ.get('API_ID', '14897265'))
API_HASH = environ.get('API_HASH', '1eae017d2fbbfb2b8ec40a61fa1a9078')
BOT_TOKEN = environ.get('BOT_TOKEN', '5967465873:AAGaxbtQY3DHjb1Ouj0n1E6NywsWbraFgrM')
...
# Bot Admins
ADMINS = [int(admins) if id_pattern.search(admins) else admins for admins in environ.get('ADMINS', '687209842').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001791435166')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001778620883'))

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Rrr:Rrr23@cluster0.tyzkjzz.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/Hdnewtamilmovies4K')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/Hdnewtamilmovies4K')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "{file_name}  🔘 size - {file_size}  ╔═════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╗ 💥 𝙅𝙊𝙄𝙉 :- @Hdnewtamilmovies4K ╚═════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╝")
